...
Route::delete('deletepurse/{id}', 'PurseController@destroy')->name('purse.destroy');
...
Route::delete('deletecategory/{id}', 'CategoryController@destroy')->name('category.destroy');
...
Route::delete('deletetrade/{id}', 'TradeController@destroy')->name('trade.destroy');
