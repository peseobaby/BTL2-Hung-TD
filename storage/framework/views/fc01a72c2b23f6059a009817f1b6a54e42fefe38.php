            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo e(route('category.create')); ?>" class ="button" >Thêm Danh mục</a> <br/> <br/>
                        <div id="menu">
                            <ul>
                        ...
                        <table width="100%" border="1" cellspacing="0" cellpadding="10">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('category.edit',$category->id)); ?>"><button class="edit">Sửa</button></a>
